...
$di['frontend_transaksi_manager'] = function () {
    return new App\Frontend\Managers\TransaksiManager();
};

$di['frontend_bantuan_manager'] = function () {
    return new App\Frontend\Managers\BantuanManager();
};
